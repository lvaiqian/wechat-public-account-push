export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxc0c979e562645288",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "a439b5e39e992b607eb375d3b148352f",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2006", "date": "05-19"},
        {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "05-19"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "李四", "year": "1996", "date": "05-19"},
        {"type": "节日", "name": "被搭讪纪念日", "year": "2021", "date": "05-19"},
      ],
    ...
    },
    {
      ...
      horoscopeDateType: '今日',
      openUrl: "https://wangxinleo.cn",
      festivals: [ {"type": "*生日", "name": "婷婷", "year": "2006", "date": "05-19"}],
